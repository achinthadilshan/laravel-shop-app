<nav
    ...
    <div class="flex flex-wrap items-center justify-between">
        ...
        <div class="flex items-center lg:order-2">
            ...
            <button type="button" class="flex mx-3 text-sm rounded-full bg-slate-800 md:mr-0" id="user-menu-button"
                ...
                <ul class="py-1 text-slate-700 dark:text-slate-300" aria-labelledby="dropdown">
                    <li>
                        <button type="button" wire:click="logout"
                            class="block w-full px-4 py-2 text-sm hover:bg-slate-100 dark:hover:bg-slate-600 dark:hover:text-white">Sign
                            out</button>
                    </li>
                </ul>
            </div>
